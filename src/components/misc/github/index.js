...
const Github = () => {
  ...
  return (
    <div key={data.length} style={{ minHeight: 450 }} className='row position-relative'>
      ...
      <div className='col-md-12'>{errorMessage && <code>{errorMessage}</code>}</div>
      <div className='col-md-12'>
              ...
              return (
                <div className='col-md-4 mb-3'>
                  <div className='repo-holder'>
                    <a tarrget='_blank' href={url} className='repo-name d-block'>
                      {name}
                    </a>
      ...
      >
        <Form onFinish={onFinish} name='basic'>
          <span className='d-block mb-2'>
            To activate github extension please insert a valid github username and, optionally, a personal github token
            with <code>repos:read</code> permissions if you want private repos listed.
          </span>
          <Form.Item
            name='username'
